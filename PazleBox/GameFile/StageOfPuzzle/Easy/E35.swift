...
class EStage35 {
   ...
   private func InitPuzzle(SizeX: CGFloat, SizeY: CGFloat){
      ...
      Puzzle2 = puzzle(PX: 4, PY: 3, CustNum: 1, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "43p46", PuzzleColor: "Red", RespawnX: 2, RespawnY: 10)
      
      Puzzle3 = puzzle(PX: 3, PY: 3, CustNum: 2, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "33p19", PuzzleColor: "Blue", RespawnX: 6, RespawnY: 10)
      
      Puzzle4 = puzzle(PX: 4, PY: 3, CustNum: 3, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "43p34", PuzzleColor: "Green", RespawnX: 5, RespawnY: 9)
   }
