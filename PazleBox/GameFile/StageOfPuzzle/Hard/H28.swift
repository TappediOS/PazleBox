...
class HStage28 {
   ...
   private func InitPuzzle(SizeX: CGFloat, SizeY: CGFloat){
      ...
      Puzzle2 = puzzle(PX: 4, PY: 3, CustNum: 1, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "43p45", PuzzleColor: "Blue", RespawnX: 1, RespawnY: 10)
      
      Puzzle3 = puzzle(PX: 3, PY: 3, CustNum: 2, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "33p28", PuzzleColor: "Blue", RespawnX: 6, RespawnY: 10)
      
      Puzzle4 = puzzle(PX: 4, PY: 3, CustNum: 3, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "43p47", PuzzleColor: "Green", RespawnX: 2, RespawnY: 9)
      
      Puzzle5 = puzzle(PX: 4, PY: 3, CustNum: 4, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "43p34", PuzzleColor: "Red", RespawnX: 3, RespawnY: 9)
      
      Puzzle6 = puzzle(PX: 3, PY: 3, CustNum: 5, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "33p4", PuzzleColor: "Blue", RespawnX: 4, RespawnY: 8)
      
      Puzzle7 = puzzle(PX: 2, PY: 3, CustNum: 6, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "23p14", PuzzleColor: "Green", RespawnX: 6, RespawnY: 8)
      
      Puzzle8 = puzzle(PX: 3, PY: 2, CustNum: 7, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "32p2", PuzzleColor: "Red", RespawnX: 1, RespawnY: 7)
