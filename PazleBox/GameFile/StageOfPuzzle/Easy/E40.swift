...
class EStage40 {
   ...
   private func InitPuzzle(SizeX: CGFloat, SizeY: CGFloat){
      Puzzle1 = puzzle(PX: 3, PY: 2, CustNum: 0, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "32p11", PuzzleColor: "Red", RespawnX: 0, RespawnY: 1)
      ...
      Puzzle3 = puzzle(PX: 4, PY: 3, CustNum: 2, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "43p13", PuzzleColor: "Blue", RespawnX: 5, RespawnY: 5)
      
      Puzzle4 = puzzle(PX: 4, PY: 3, CustNum: 3, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "43p40", PuzzleColor: "Green", RespawnX: 0, RespawnY: 4)
      
      Puzzle5 = puzzle(PX: 3, PY: 3, CustNum: 4, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "33p26", PuzzleColor: "Red", RespawnX: 6, RespawnY: 2)
   ...
   private func InitHint(SizeX: CGFloat, SizeY: CGFloat) {
      ...
      Hint2 = HintPuzzle(PX: 4, PY: 3, CustNum: 1, ViewX: Int(SizeX), ViewY: Int(SizeY), PuzzleStyle: "43p40", PuzzleColor: "Green", AnsX: 2, AnsY: 9)
   }
